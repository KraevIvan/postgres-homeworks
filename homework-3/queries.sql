...
SELECT customers.company_name, CONCAT(employees.first_name, ' ', employees.last_name) AS employee, ship_via, shippers.shipper_id
FROM orders
...
SELECT DISTINCT products.product_name, quantity FROM order_details
